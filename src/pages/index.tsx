  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application - Your comprehensive solution for seamless and efficient Human Resources operations."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application - Your comprehensive solution for seamless and efficient Human Resources operations.`}
            </Text>
            <Box
